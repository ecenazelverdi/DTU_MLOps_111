...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        model_folder = os.path.join("nnUNet_results", "Dataset101_DroneSeg", "nnUNetTrainer__nnUNetPlans__2d")
    ...
    def predict(self, image: np.ndarray) -> np.ndarray:
        ...
        ret = self.predictor.predict_single_npy_array(image, props, None, None, False)
